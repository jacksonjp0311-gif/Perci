#!/usr/bin/env python3
"""Evaluate whether Bitwork v3 transfers prompts to relevant stored concepts."""
...
CASES = [
    ...
    ("logic-falsification", "what makes a claim falsifiable with a competing prediction", "logic", "falsification"),
    ("logic-argument-structure", "separate observation premise inference conclusion and uncertainty", "logic", "argument structure"),
    ("planning-acceptance", "what acceptance gate and receipt should justify promoting a change", "planning", "acceptance"),
    ("explanation-depth", "what makes deep reasoning a causal chain with a boundary and a test", "explanation", "deep reasoning"),
    ("explanation-response-fit", "how should a response fit the requested operation and uncertainty", "explanation", "response fit"),
...
def main() -> int:
    ...
    receipt = {
        "schema": "perci.concept-transfer.v3",
